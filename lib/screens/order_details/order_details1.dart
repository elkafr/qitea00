...
class OrderDetails1Screen extends StatefulWidget {
  @override
  _OrderDetails1ScreenState createState() => _OrderDetails1ScreenState();
}
                      ...
                      onCameraMove: (_position) {
                        ...
                        _markers.add(
                          Marker(
                            ...
                            position: LatLng(_position.target.latitude,
        ...
        child: ListView(
          children: <Widget>[
            ...
            order.carttDone == 3
                ? Container(
                    height: _height * .3,
                    child: FutureBuilder<List<Offer1>>(
                      future: _offersList1,
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          if (snapshot.data!.length > 0) {
