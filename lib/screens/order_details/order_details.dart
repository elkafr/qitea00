...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  Widget _buildBodyItem(Order order) {
      ...
      child: Container(
        ...
        child: ListView(
          children: <Widget>[
            ...
            (order.carttDone==1) && _appState.currentOfferCartt!="0" && _appState.currentOfferMtger!=""?Container(
          ...
          decoration: BoxDecoration(
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text(snapshot.data.offerMtgerName.toString(),style: TextStyle()),
                            ],
                          ),
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              RatingBar.builder(
                                initialRating:  double.parse(snapshot.data.offerMtgerRate),
                                minRating: 1,
            ...
            ( order.carttDone==2 || order.carttDone==3 || order.carttDone==4 || order.carttDone==5 || order.carttDone==6 || order.carttDone==7) && _appState.currentOfferCartt!="0" && _appState.currentOfferMtger!=""?Container(
              padding: EdgeInsets.all(30),
              margin: EdgeInsets.only(
                  left: _width * 0.03,
                  right:_width * 0.03,
            ...
            (order.carttDone==2 ||  order.carttDone==5 || order.carttDone==6 || order.carttDone==7)?Container(
              padding: EdgeInsets.all(30),
              margin: EdgeInsets.only(
                  left: _width * 0.03,
                  right:_width * 0.03,
            ...
            (order.carttDone==3) && _appState.currentOfferCartt!="0" && _appState.currentOfferDriver!="0"?Container(
              padding: EdgeInsets.all(30),
              margin: EdgeInsets.only(
                  left: _width * 0.03,
                  right:_width * 0.03,
                        ...
                        return Column(
                          children: <Widget>[
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Text("اسم المندوب", style: TextStyle(
                                    fontWeight: FontWeight.bold),),
                                Text(snapshot.data.offerDriverName.toString(),
                                    style: TextStyle()),
                              ],
                            ),
                            SizedBox(height: _width * .04,),
            ...
            (order.carttDone==4 || order.carttDone==5 || order.carttDone==6 || order.carttDone==7)?Container(
              padding: EdgeInsets.all(30),
              margin: EdgeInsets.only(
                  left: _width * 0.03,
                  right:_width * 0.03,
              ...
              child: Column(
                children: <Widget>[
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      Text("اسم المندوب",style: TextStyle(fontWeight: FontWeight.bold),),
                      Text(order.carttDriverName.toString(),style: TextStyle()),
                    ],
                  ),
                  SizedBox(height: _width*.04,),
                  Row(
                    ...
                    children: <Widget>[
                      Text("التقييم",style: TextStyle(fontWeight: FontWeight.bold),),
                      RatingBar.builder(
                        initialRating:  double.parse(order.carttDriverRate),
                        minRating: 1,
                        direction: Axis.horizontal,
                        allowHalfRating: true,
                        itemCount: 5,
    ...
    Spacer(),
    Container(
    child: Text(snapshot.data.offerPrice.toString(),style: TextStyle(color: Colors.white)),
    color: cLightLemon,
    padding: EdgeInsets.only(top: 4,bottom: 4,left: 7,right: 7),
    ),
    Padding(padding: EdgeInsets.all(3)),
    Text("SR",style: TextStyle(),),
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Spacer(),
                      Container(
                        child: Text(order.carttPrice1,style: TextStyle(color: Colors.white)),
                        color: cLightLemon,
                        padding: EdgeInsets.only(top: 4,bottom: 4,left: 7,right: 7),
                      ),
                      Padding(padding: EdgeInsets.all(3)),
            ...
            (order.carttDone==4 || order.carttDone==7)?Container(
              padding: EdgeInsets.only(right: _width*.08,left:  _width*.08,top: 10,bottom: 10),
              margin: EdgeInsets.only(
                  left: _width * 0.03,
                  right:_width * 0.03,
                  bottom:_width * 0.02),
...
mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  Container(
                    child: Text("قيمة العرض ",style: TextStyle(color: cPrimaryColor),),
                    width: _width*.32,
                  ),
                 Container(width: 2,height: 35,color: Colors.grey[200]),
               Row(
                 children: <Widget>[
                   Text(order.carttPrice,style: TextStyle(color: cPrimaryColor)),
                   Padding(padding: EdgeInsets.all(3)),
            ...
            (order.carttDone==4 || order.carttDone==7)?Container(
              ...
              child:Row(
                ...
                children: <Widget>[
                  Container(
                    child: Text("قيمة عرض التوصيل ",style: TextStyle(color: cPrimaryColor),),
                    width: _width*.32,
                  ),
                  Container(width: 2,height: 35,color: Colors.grey[200]),
                  Row(
                    children: <Widget>[
                      Text(order.carttPrice1,style: TextStyle(color: cPrimaryColor)),
                      Padding(padding: EdgeInsets.all(3)),
                      Text("SR",style: TextStyle(color: cPrimaryColor),),
                    ],
                  )
            ...
            (order.carttDone==4 || order.carttDone==7)?Container(
              ...
              child:Row(
                ...
                children: <Widget>[
                  Container(
                    child: Text("رسوم ادارية ",style: TextStyle(color: cPrimaryColor),),
                    width: _width*.28,
                  ),
                  Container(width: 2,height: 35,color: Colors.grey[200]),
                  Row(
                    children: <Widget>[
                      Text(order.carttFees,style: TextStyle(color: cPrimaryColor)),
                      Padding(padding: EdgeInsets.all(3)),
                      Text("SR",style: TextStyle(color: cPrimaryColor),),
                    ],
                  )
            ...
            (order.carttDone==4 || order.carttDone==7)?Container(
              ...
              child:Row(
                ...
                children: <Widget>[
                  Container(
                    child: Text("القيمة المضافة ",style: TextStyle(color: cPrimaryColor),),
                    width: _width*.28,
                  ),
                  Container(width: 2,height: 35,color: Colors.grey[200]),
                  Row(
            ...
            (order.carttDone==4 || order.carttDone==7)?Container(
              ...
              child:Row(
                ...
                children: <Widget>[
                  Container(
                    child: Text("الاجمالي ",style: TextStyle(color: cPrimaryColor),),
                    width: _width*.37,
                  ),
                  Container(width: 2,height: 35,color: Colors.grey[200]),
                  Row(
                    children: <Widget>[
                      Text(order.carttTotal,style: TextStyle(color: cPrimaryColor)),
                      Padding(padding: EdgeInsets.all(3)),
                      Text("SR",style: TextStyle(color: cPrimaryColor),),
                    ],
                  )
      ...
      return Row(
        ...
        children: <Widget>[
          ...
          Container(
                                    ...
                                    GestureDetector(
                                        onTap: () async {
                                          _progressIndicatorState.setIsLoading(
                                              true);
                                          var results = await _services.get(
                                              'https://qtaapp.com/api/acceptOffer1?cartt_id=${snapshot
                                                  .data
                                                  .offerCartt}&offer_id=${snapshot
                                                  .data
                                                  .offerId}&lang=${_appState
                                                  .currentLang}');
                                          _progressIndicatorState.setIsLoading(
                                              false);
                                          if (results['response'] == '1') {
                    ...
                    if (snapshot.hasData) {
                      return Column(
                        ...
                        children: <Widget>[
                          ...
                          Text("القطعة 1",style: TextStyle(fontWeight: FontWeight.bold),),
                          SizedBox(height: _width*.02,),
                          snapshot.data.offerType==0?Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Text(snapshot.data.requestLabel1.toString()),
                              Text(" سعر "+ snapshot.data.requestPrice1.toString()+" ريال "),
                              Container(
                                alignment: Alignment.center,
                                child: snapshot.data.requestPrice1Act==0?GestureDetector(
                                  child: Container(
                                    alignment: Alignment.center,
                                    width:_width*.20,
                                    child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                    color: Colors.green,
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      GestureDetector(
                                                          onTap: () async{
                                                            ...
                                                            _progressIndicatorState.setIsLoading(true);
                                                            var results = await _services.get(
                                                                'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice1Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                            _progressIndicatorState.setIsLoading(false);
                                                            if (results['response'] == '1') {
                                                              showToast(results['message'], context);
                                ...
                                ):(snapshot.data.requestPrice1Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                              )
                            ],
                          ):Column(
                            children: <Widget>[
                              snapshot.data.requestPrice1Offer1!=0?Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(snapshot.data.requestPrice1Label1.toString()),
                                  Text(" سعر "+ snapshot.data.requestPrice1Offer1.toString()+" ريال "),
                                  Container(
                                    alignment: Alignment.center,
                                    child: snapshot.data.requestPrice1Offer1Act==0?GestureDetector(
                                      child: Container(
                                        alignment: Alignment.center,
                                        width:_width*.20,
                                        child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          GestureDetector(
                                                              onTap: () async{
                                                                ...
                                                                _progressIndicatorState.setIsLoading(true);
                                                                var results = await _services.get(
                                                                    'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice1Offer1Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                    ...
                                    ):(snapshot.data.requestPrice1Offer1Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                                  )
                                ],
                              ):Text("",style: TextStyle(height: 0),),
                              ...
                              snapshot.data.requestPrice1Offer2!=0?Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(snapshot.data.requestPrice1Label2.toString()),
                                  Text(" سعر "+ snapshot.data.requestPrice1Offer2.toString()+" ريال "),
                                  Container(
                                    alignment: Alignment.center,
                                    child: snapshot.data.requestPrice1Offer2Act==0?GestureDetector(
                                      child: Container(
                                        alignment: Alignment.center,
                                        width:_width*.20,
                                        child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          GestureDetector(
                                                              onTap: () async{
                                                                ...
                                                                _progressIndicatorState.setIsLoading(true);
                                                                var results = await _services.get(
                                                                    'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice1Offer2Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                                _progressIndicatorState.setIsLoading(false);
                                                                if (results['response'] == '1') {
                                                                  showToast(results['message'], context);
                                    ...
                                    ):(snapshot.data.requestPrice1Offer2Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                                  )
                                ],
                              ):Text("",style: TextStyle(height: 0),),
                              ...
                              snapshot.data.requestPrice1Offer3!=0?Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(snapshot.data.requestPrice1Label3.toString()),
                                  Text(" سعر "+ snapshot.data.requestPrice1Offer3.toString()+" ريال "),
                                  Container(
                                    alignment: Alignment.center,
                                    child: snapshot.data.requestPrice1Offer3Act==0?GestureDetector(
                                      child: Container(
                                        alignment: Alignment.center,
                                        width:_width*.20,
                                        child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          GestureDetector(
                                                              onTap: () async{
                                                                ...
                                                                _progressIndicatorState.setIsLoading(true);
                                                                var results = await _services.get(
                                                                    'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice1Offer3Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                                _progressIndicatorState.setIsLoading(false);
                                                                if (results['response'] == '1') {
                                                                  showToast(results['message'], context);
                                    ...
                                    ):(snapshot.data.requestPrice1Offer3Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                                  )
                                ],
                              ):Text("",style: TextStyle(height: 0),),
                            ],
                          ...
                          order.carttNumber=="2" || order.carttNumber=="3"?SizedBox(height: _width*.04,):Text("",style: TextStyle(height: 0),),
                          order.carttNumber=="2" || order.carttNumber=="3"?Text("القطعة 2",style: TextStyle(fontWeight: FontWeight.bold),):Text("",style: TextStyle(height: 0),),
                          order.carttNumber=="2" || order.carttNumber=="3"?SizedBox(height: _width*.02,):Text("",style: TextStyle(height: 0),),
                          order.carttNumber=="2" || order.carttNumber=="3"?snapshot.data.offerType==0?Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Text(snapshot.data.requestLabel2.toString()),
                              Text(" سعر "+ snapshot.data.requestPrice2.toString()+" ريال "),
                              Container(
                                alignment: Alignment.center,
                                child: snapshot.data.requestPrice2Act==0?GestureDetector(
                                  child: Container(
                                    alignment: Alignment.center,
                                    width:_width*.20,
                                    child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      GestureDetector(
                                                          onTap: () async{
                                                            ...
                                                            _progressIndicatorState.setIsLoading(true);
                                                            var results = await _services.get(
                                                                'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice2Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                            _progressIndicatorState.setIsLoading(false);
                                                            if (results['response'] == '1') {
                                                              showToast(results['message'], context);
                                ...
                                ):(snapshot.data.requestPrice2Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                              )
                            ],
                          ):Column(
                            children: <Widget>[
                              snapshot.data.requestPrice2Offer1!=0?Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(snapshot.data.requestPrice2Label1.toString()),
                                  Text(" سعر "+ snapshot.data.requestPrice2Offer1.toString()+" ريال "),
                                  Container(
                                    alignment: Alignment.center,
                                    child: snapshot.data.requestPrice2Offer1Act==0?GestureDetector(
                                      child: Container(
                                        alignment: Alignment.center,
                                        width:_width*.20,
                                        child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          GestureDetector(
                                                              onTap: () async{
                                                                ...
                                                                _progressIndicatorState.setIsLoading(true);
                                                                var results = await _services.get(
                                                                    'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice2Offer1Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                                _progressIndicatorState.setIsLoading(false);
                                                                if (results['response'] == '1') {
                                                                  showToast(results['message'], context);
                                    ...
                                    ):(snapshot.data.requestPrice2Offer1Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                                  )
                                ],
                              ):Text("",style: TextStyle(height: 0),),
                              ...
                              snapshot.data.requestPrice2Offer2!=0?Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(snapshot.data.requestPrice2Label2.toString()),
                                  Text(" سعر "+ snapshot.data.requestPrice2Offer2.toString()+" ريال "),
                                  Container(
                                    alignment: Alignment.center,
                                    child: snapshot.data.requestPrice2Offer2Act==0?GestureDetector(
                                      child: Container(
                                        alignment: Alignment.center,
                                        width:_width*.20,
                                        child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          GestureDetector(
                                                              onTap: () async{
                                                                ...
                                                                _progressIndicatorState.setIsLoading(true);
                                                                var results = await _services.get(
                                                                    'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice2Offer2Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                                _progressIndicatorState.setIsLoading(false);
                                                                if (results['response'] == '1') {
                                                                  showToast(results['message'], context);
                                    ...
                                    ):(snapshot.data.requestPrice2Offer2Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                                  )
                                ],
                              ):Text("",style: TextStyle(height: 0),),
                              ...
                              snapshot.data.requestPrice2Offer3!=0?Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(snapshot.data.requestPrice2Label3.toString()),
                                  Text(" سعر "+ snapshot.data.requestPrice2Offer3.toString()+" ريال "),
                                  Container(
                                    alignment: Alignment.center,
                                    child: snapshot.data.requestPrice2Offer3Act==0?GestureDetector(
                                      child: Container(
                                        alignment: Alignment.center,
                                        width:_width*.20,
                                        child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          GestureDetector(
                                                              onTap: () async{
                                                                ...
                                                                _progressIndicatorState.setIsLoading(true);
                                                                var results = await _services.get(
                                                                    'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice2Offer3Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                                _progressIndicatorState.setIsLoading(false);
                                                                if (results['response'] == '1') {
                                                                  showToast(results['message'], context);
                                    ...
                                    ):(snapshot.data.requestPrice2Offer3Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                                  )
                                ],
                              ):Text("",style: TextStyle(height: 0),),
                            ],
                          ...
                          order.carttNumber=="3"?SizedBox(height: _width*.04,):Text("",style: TextStyle(height: 0),),
                          order.carttNumber=="3"?Text("القطعة 3",style: TextStyle(fontWeight: FontWeight.bold),):Text("",style: TextStyle(height: 0),),
                          order.carttNumber=="3"?SizedBox(height: _width*.02,):Text("",style: TextStyle(height: 0),),
                          order.carttNumber=="3"?snapshot.data.offerType==0?Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Text(snapshot.data.requestLabel3.toString()),
                              Text(" سعر "+ snapshot.data.requestPrice3.toString()+" ريال "),
                              Container(
                                alignment: Alignment.center,
                                child: snapshot.data.requestPrice3Act==0?GestureDetector(
                                  child: Container(
                                    alignment: Alignment.center,
                                    width:_width*.20,
                                    child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      GestureDetector(
                                                          onTap: () async{
                                                            ...
                                                            _progressIndicatorState.setIsLoading(true);
                                                            var results = await _services.get(
                                                                'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice3Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                            _progressIndicatorState.setIsLoading(false);
                                                            if (results['response'] == '1') {
                                                              showToast(results['message'], context);
                                ...
                                ):(snapshot.data.requestPrice3Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                              )
                            ],
                          ):Column(
                            children: <Widget>[
                              snapshot.data.requestPrice3Offer1!=0?Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(snapshot.data.requestPrice3Label1.toString()),
                                  Text(" سعر "+ snapshot.data.requestPrice3Offer1.toString()+" ريال "),
                                  Container(
                                    alignment: Alignment.center,
                                    child: snapshot.data.requestPrice3Offer1Act==0?GestureDetector(
                                      child: Container(
                                        alignment: Alignment.center,
                                        width:_width*.20,
                                        child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          GestureDetector(
                                                              onTap: () async{
                                                                ...
                                                                _progressIndicatorState.setIsLoading(true);
                                                                var results = await _services.get(
                                                                    'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice3Offer1Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                                _progressIndicatorState.setIsLoading(false);
                                                                if (results['response'] == '1') {
                                                                  showToast(results['message'], context);
                                    ...
                                    ):(snapshot.data.requestPrice3Offer1Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                                  )
                                ],
                              ):Text("",style: TextStyle(height: 0),),
                              ...
                              snapshot.data.requestPrice3Offer2!=0?Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(snapshot.data.requestPrice3Label2.toString()),
                                  Text(" سعر "+ snapshot.data.requestPrice3Offer2.toString()+" ريال "),
                                  Container(
                                    alignment: Alignment.center,
                                    child: snapshot.data.requestPrice3Offer2Act==0?GestureDetector(
                                      child: Container(
                                        alignment: Alignment.center,
                                        width:_width*.20,
                                        child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          GestureDetector(
                                                              onTap: () async{
                                                                ...
                                                                _progressIndicatorState.setIsLoading(true);
                                                                var results = await _services.get(
                                                                    'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice3Offer2Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                                _progressIndicatorState.setIsLoading(false);
                                                                if (results['response'] == '1') {
                                                                  showToast(results['message'], context);
                                    ...
                                    ):(snapshot.data.requestPrice3Offer2Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                                  )
                                ],
                              ):Text("",style: TextStyle(height: 0),),
                              ...
                              snapshot.data.requestPrice3Offer3!=0?Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(snapshot.data.requestPrice3Label3.toString()),
                                  Text(" سعر "+ snapshot.data.requestPrice3Offer3.toString()+" ريال "),
                                  Container(
                                    alignment: Alignment.center,
                                    child: snapshot.data.requestPrice3Offer3Act==0?GestureDetector(
                                      child: Container(
                                        alignment: Alignment.center,
                                        width:_width*.20,
                                        child: Text("قبول",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          GestureDetector(
                                                              onTap: () async{
                                                                ...
                                                                _progressIndicatorState.setIsLoading(true);
                                                                var results = await _services.get(
                                                                    'https://qtaapp.com/api/acceptRequest?lang=ar&type=requestPrice3Offer3Act&offer_id=${snapshot.data.offerId}&lang=${_appState.currentLang}');
                                                                _progressIndicatorState.setIsLoading(false);
                                                                if (results['response'] == '1') {
                                                                  showToast(results['message'], context);
                                    ...
                                    ):(snapshot.data.requestPrice3Offer3Act==1?Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.cancel,color: Colors.red,)),
                                  )
                                ],
                              ):Text("",style: TextStyle(height: 0),),
                            ],
                          ...
                          GestureDetector(
                            child: Center(
                              child: Container(
                                alignment: Alignment.center,
                                width:_width,
                                child: Text("تأكيد قبول الاسعار",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                color: cLightLemon,
                                padding: EdgeInsets.only(top: 10,bottom: 10,right: 14,left: 14),
                              ),
                            ),
            ...
            order.carttDone==4 && order.carttPay==0?Container(
                                      ...
                                      GestureDetector(
                                        ...
                                        onTap: () async{
                                          ...
                                          if (results['status'] == true) {
                                            _appState.setCurrentUrl(results['id']);
                                            print("Sssss");
                                            print(_appState.url);
                                            print("Sssss");
                                            Navigator.push(
            ...
            order.carttDone==2 && _appState.currentOfferCartt!="0" && _appState.currentOfferMtger!=""?Container(
              padding: EdgeInsets.all(10),
              margin: EdgeInsets.only(
                  left: _width * 0.03,
                  right:_width * 0.03,
              ...
              child: Row(
                children: <Widget>[
                  Text("قيمة العرض",style: TextStyle(color: Colors.white),),
                  Spacer(flex: 1,),
                  Container(width: 1,color: Colors.grey[200],),
                  Spacer(flex: 1,),
                  Text(order.carttPrice+ " ريال ",style: TextStyle(color: Colors.white),),
                ],
              ),
            ):Text("",style: TextStyle(height: 0),),
            ...
            order.carttDone==2 && _appState.currentOfferCartt!="0" && _appState.currentOfferMtger!=""?Container(
              child:_locationState.anotherAdress=="0"?CustomButton(
            ...
            order.carttState=="0"?CustomButton(
                btnStyle: TextStyle(
                    fontWeight: FontWeight.w600,
                    fontSize: 15,
                    color: cWhite),
            ...
            (order.carttDone==7)?Container(
              ...
              child:Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  Text("تحميل فاتورة ضريبة القيمة المضافة ",style: TextStyle(color: cPrimaryColor,fontSize: 13),),
                  GestureDetector(
                    child: Icon(Icons.file_download,size: 35,color: cBlack,),
                    onTap: (){
                      launch('https://qtaapp.com/site/fatora/'+order.carttId.toString());
                    },
                  )
                ],
              ),
                                        ...
                                        child:  Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Container(
                                              ...
                                              child: Text("تقييم المندوب",style: TextStyle(
                                                  color: cWhite,fontSize: 16,
                                                  fontWeight: FontWeight.w700
                                              ),),
                                            ),
                                        ...
                                        child:  Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Container(
                                              ...
                                              child: Text("تقييم البائع",style: TextStyle(
                                                  color: cWhite,fontSize: 16,
                                                  fontWeight: FontWeight.w700
                                              ),),
                                            ),
                               ...
                               child: GestureDetector(
                                 child: Row(
                                   children: <Widget>[
                                     ...
                                     Text("الغاء",style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold),)
                                   ],
                                 ),
                                 onTap: (){
                                   showModalBottomSheet(
